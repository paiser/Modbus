...
//--------------------------------------------------------
/**
 * method : 		ModbusClass::ModbusClass(std::string &s)
 * description : 	constructor for the ModbusClass
 *
 * @param s	The class name
 */
//--------------------------------------------------------
ModbusClass::ModbusClass(std::string &s):Tango::DeviceClass(s)
{
	TANGO_LOG_INFO << "Entering ModbusClass constructor" << std::endl;
	...
	TANGO_LOG_INFO << "Leaving ModbusClass constructor" << std::endl;
}
...
{
	TANGO_LOG_INFO << "ForceSingleCoilClass::execute(): arrived" << std::endl;
...
{
	TANGO_LOG_INFO << "ReadCoilStatusClass::execute(): arrived" << std::endl;
...
{
	TANGO_LOG_INFO << "ReadInputStatusClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "ReadHoldingRegistersClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "ReadInputRegistersClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "PresetSingleRegisterClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "FetchCommEventCtrClass::execute(): arrived" << std::endl;
...
{
	TANGO_LOG_INFO << "ForceMultipleCoilsClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "ReadMultipleCoilsStatusClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "PresetMultipleRegistersClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "MaskWriteRegisterClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "ReadWriteRegisterClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "PresetSingleRegisterBroadcastClass::execute(): arrived" << std::endl;
	const Tango::DevVarShortArray *argin;
	extract(in_any, argin);
...
{
	TANGO_LOG_INFO << "ReadExceptionStatusClass::execute(): arrived" << std::endl;
 ...
 */
//--------------------------------------------------------
Tango::DbDatum ModbusClass::get_class_property(std::string &prop_name)
{
 ...
 */
//--------------------------------------------------------
Tango::DbDatum ModbusClass::get_default_device_property(std::string &prop_name)
{
 ...
 */
//--------------------------------------------------------
Tango::DbDatum ModbusClass::get_default_class_property(std::string &prop_name)
{
...
void ModbusClass::set_default_property()
{
	...
	if (prop_def.length()>0)
	{
		...
		add_wiz_dev_prop(prop_name, prop_desc);
	prop_name = "Port";
	prop_desc = "The port of the host modbus connection for the TCP protocol. Defaults to 502";
	prop_def  = "502";
	vect_data.clear();
	vect_data.push_back("502");
	if (prop_def.length()>0)
	{
		Tango::DbDatum	data(prop_name);
		data << vect_data ;
 ...
 */
//--------------------------------------------------------
void ModbusClass::attribute_factory(std::vector<Tango::Attr *> &att_list)
{
 ...
 */
//--------------------------------------------------------
void ModbusClass::create_static_attribute_list(std::vector<Tango::Attr *> &att_list)
{
 ...
 */
//--------------------------------------------------------
void ModbusClass::erase_dynamic_attributes(const Tango::DevVarStringArray *devlist_ptr, std::vector<Tango::Attr *> &att_list)
{
 ...
 */
//--------------------------------------------------------
Tango::Attr *ModbusClass::get_attr_object_by_name(std::vector<Tango::Attr *> &att_list, std::string attname)
{
