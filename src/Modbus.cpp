 ...
 */
//--------------------------------------------------------
Modbus::Modbus(Tango::DeviceClass *cl, std::string &s)
...
{
	DEBUG_STREAM << "Modbus::delete_device() " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::init_device() create device " << device_name << std::endl;
	...
	if (cacheConfig.empty() == false)
	{
		...
		{
			std::string cmd = cacheConfig[i * 3];
...
{
	DEBUG_STREAM << "Modbus::always_executed_hook()  " << device_name << std::endl;
 ...
 */
//--------------------------------------------------------
void Modbus::read_attr_hardware(TANGO_UNUSED(std::vector<long> &attr_list))
{
	DEBUG_STREAM << "Modbus::read_attr_hardware(std::vector<long> &attr_list) entering... " << std::endl;
...
{
	DEBUG_STREAM << "Modbus::ForceSingleCoil()  - " << device_name << std::endl;
...
Tango::DevShort Modbus::read_coil_status(Tango::DevShort argin)
{
	...
	DEBUG_STREAM << "Modbus::ReadCoilStatus()  - " << device_name << std::endl;
...
Tango::DevVarCharArray *Modbus::read_input_status(const Tango::DevVarShortArray *argin)
{
	...
	DEBUG_STREAM << "Modbus::ReadInputStatus()  - " << device_name << std::endl;
...
Tango::DevVarShortArray *Modbus::read_holding_registers(const Tango::DevVarShortArray *argin)
{
	...
	DEBUG_STREAM << "Modbus::ReadHoldingRegisters()  - " << device_name << std::endl;
...
{
	Tango::DevVarShortArray *argout;
	DEBUG_STREAM << "Modbus::ReadInputRegisters()  - " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::PresetSingleRegister()  - " << device_name << std::endl;
...
{
	Tango::DevVarShortArray *argout;
	DEBUG_STREAM << "Modbus::FetchCommEventCtr()  - " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::ForceMultipleCoils()  - " << device_name << std::endl;
...
{
	Tango::DevVarShortArray *argout;
	DEBUG_STREAM << "Modbus::ReadMultipleCoilsStatus()  - " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::PresetMultipleRegisters()  - " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::MaskWriteRegister()  - " << device_name << std::endl;
...
{
	Tango::DevVarShortArray *argout;
	DEBUG_STREAM << "Modbus::ReadWriteRegister()  - " << device_name << std::endl;
...
{
	DEBUG_STREAM << "Modbus::PresetSingleRegisterBroadcast()  - " << device_name << std::endl;
...
{
	Tango::DevShort argout;
	DEBUG_STREAM << "Modbus::ReadExceptionStatus()  - " << device_name << std::endl;
